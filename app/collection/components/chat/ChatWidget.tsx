                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
                                    <div className="hub-chat-header">
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginLeft: 'auto' }}>
                                            ...
                                            <a href={`https://web3.okx.com/explorer/x-layer/evm/address/${selectedPeer}`} target="_blank" rel="noreferrer" title={t.viewExplorer || "View OKX Explorer"} className="hub-messenger-action-btn"><ExternalLink size={20} /></a>
