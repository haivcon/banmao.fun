            ...
            <div className="hub-profile-info-section">
                ...
                <div className="hub-profile-details">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                        <p 
                            className="hub-profile-address" 
                            title={t.copyAddress || "Copy Address"}
                            onClick={() => navigator.clipboard.writeText(profileAddress)}
                            style={{ cursor: 'pointer', margin: 0, display: 'inline-flex', alignItems: 'center', gap: '4px' }}
                        >
                            {profileAddress}
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                        </p>
                        <a 
                            href={`https://web3.okx.com/explorer/x-layer/evm/address/${profileAddress}`}
                            target="_blank" 
                            rel="noopener noreferrer"
                            title={t.viewExplorer || "View Explorer"}
                            style={{ color: 'var(--hub-text-muted)', display: 'inline-flex', alignItems: 'center' }}
                        >
