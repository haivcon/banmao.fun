...
function BackgroundLayer({ id }: { id: number }) {
  ...
  if (id === 2)
    return (
      <>
        <rect width="512" height="512" fill={bg.color} />
        <circle cx="64" cy="64" r="14" fill="#fff" opacity=".3" />
        <circle cx="448" cy="135" r="24" fill="#fff" opacity=".25" />
      </>
    );
  if (id === 3)
    return (
      <>
        <rect width="512" height="512" fill={bg.color} />
        <path d="M0 512L512 0v512z" fill={bg.accent} />
        <circle cx="75" cy="84" r="8" fill="#fff2a8" />
        <circle cx="430" cy="72" r="5" fill="#fff2a8" />
      </>
    );
  if (id === 4)
    return (
      <>
        <rect width="512" height="512" fill={bg.color} />
        <path d="M256 0v512M0 256h512" stroke={bg.accent} opacity=".16" />
        <circle cx="84" cy="80" r="3" fill="white" />
        <circle cx="425" cy="122" r="4" fill="white" />
      </>
    );
  if (id === 5)
    return (
  ...
  return (
    <>
      <rect width="512" height="512" fill={bg.color} />
      <ellipse cx="256" cy="477" rx="101" ry="13" fill="#625b52" opacity=".18" />
    </>
  );
}
...
function AccessoryContent({ id }: { id: number }) {
  if (id === 0) return null;
  if (id === 1)
    return (
      <>
        <path
          ...
          strokeWidth="6"
        />
        <circle cx="203" cy="81" r="7" fill="#ef5376" />
        <circle cx="256" cy="69" r="7" fill="#56c9ff" />
        <circle cx="309" cy="81" r="7" fill="#ef5376" />
      </>
    );
  if (id === 2)
    return (
      <path
        d="M185 292q-38-24-40 12 4 35 44 8l17 11 15-29-19 4zM327 292q38-24 40 12-4 35-44 8l-17 11-15-29 19 4z"
        fill="#ed4d4d"
        stroke="#762a2a"
        strokeWidth="5"
      />
  ...
  if (id === 3)
    return (
      <g fill="none" stroke="#5b3825" strokeWidth="6">
        ...
        <path d="M245 210h22M195 206l-18-6M317 206l18-6" />
      </g>
    );
  if (id === 4)
    return (
      <path
        d="M194 197h53v27h-13v13h-21v-13h-19zM265 197h53v27h-19v13h-21v-13h-13zM247 203h18"
        fill="#1c2033"
        stroke="#070912"
        strokeWidth="5"
      />
    ...
    return (
      <>
        <path
          ...
          strokeWidth="6"
        />
        <path d="M221 116l70-30M238 78l44-19" stroke="#ffe35e" strokeWidth="9" />
    ...
    return (
      <>
        ...
        <circle
          ...
          strokeWidth="5"
        />
        <path d="M250 334v23M263 334v23" stroke="#9d641d" strokeWidth="4" />
      </>
    );
  if (id === 7)
    return (
      <>
        <path
          d="M327 338q43-32 57 11-35 26-57-11z"
          fill="#5bcf69"
          stroke="#236b31"
          strokeWidth="5"
        />
        <path d="M332 338l40 9" stroke="#236b31" strokeWidth="4" />
      </>
    );
  if (id === 8)
    return (
      ...
      {traits.background !== 0 && (
        <defs>
          <filter id="king-shadow" x="-20%" y="-20%" width="140%" height="150%">
            <feDropShadow dx="0" dy="8" stdDeviation="6" floodColor="#12100d" floodOpacity="0.28" />
          </filter>
        </defs>
      )}
