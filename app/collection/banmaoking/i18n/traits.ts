...
const newAccessoryLabels: Record<Lang, readonly string[]> = {
  en: ['Mini Companions', 'Boxing Gloves'],
  vi: ['Cặp bạn mini', 'Găng boxing'],
  zh: ['迷你伙伴', '拳击手套'],
  ko: ['미니 친구들', '복싱 글러브'],
  ru: ['Мини-компаньоны', 'Боксёрские перчатки'],
  id: ['Teman Mini', 'Sarung Tinju'],
};
