...
import limePeel from './lime-peel-contract.json';
...
export function bodyEffects(id: number): string {
  if (id === 10) return officeSuit;
  if (id === 9) return developerSuit;
  if (id === 2) return limePeel;
  ...
  const details = [
    ...
    cyborgDetails(),
    cosmicSuit,
    emblem('<path d="M-10-14h13c14 0 14 13 0 13h-13m0 0h15c14 0 14 15 0 15h-15m4-28v28M-2-20v6m7-6v6M-2 14v6m7-6v6" fill="none" stroke="#fff5ce" stroke-width="3"/>','#df831d')+cryptoVeins(6),
    emblem('<path d="M0-20l-12 20L0-5Z" fill="#eff3ff"/><path d="M0-20L12 0 0-5Z" fill="#b6c5ef"/><path d="M-12 0L0 7 12 0 0-5Z" fill="#8b9ed0"/><path d="M-12 4L0 21 12 4 0 11Z" fill="#f2ecff"/>','#677ac5')+cryptoVeins(7),
    emblem('<path d="M-14-14h9v9h-9ZM5-14h9v9H5ZM-5-5H5V5H-5ZM-14 5h9v9h-9ZM5 5h9v9H5Z" fill="#f6f8fa"/>','#242f38')+cryptoVeins(8),
  ...
  if (id !== 11 && id !== 4 && id !== 5 && (id < 6 || id > 8)) details[id] += suitUpgrade(id >= 4 ? id + 3 : id);
  if (id === 9) {
