...
export const eyeProfiles: Record<number, { name: string; gaze: string; duration: number; blink: string }> = {
  ...
  10: { name: 'starshine', gaze: '0 0;0 -1;0 0;0 -2;0 0', duration: 3.8, blink: '0;.84;.86;.9;1' },
  ...
  15: { name: 'weary', gaze: '0 0;0 1;0 2;0 2;0 0', duration: 9, blink: '0;.7;.74;.83;1' },
  16: { name: 'side-eye', gaze: '0 0;-3 0;-3 0;2 -1;0 0', duration: 5.4, blink: '0;.9;.915;.94;1' },
  17: { name: 'bashful', gaze: '0 0;1 2;2 2;1 1;0 0', duration: 4.8, blink: '0;.65;.68;.73;1' },
