...
export type BoxTransactionResultCopy = {
  ...
  failureTitle: string;
  failureNotSubmitted: string;
  failureSubmitted: string;
  retryCreation: string;
  editDetails: string;
  close: string;
};

export const BOX_TRANSACTION_RESULT_COPY: Record<BoxLanguage, BoxTransactionResultCopy> = {
  en: { title: "Your BanmaoBox is ready", description: "The transaction is confirmed on X Layer. This is the artwork generated on-chain for your newly minted NFT.", artworkAlt: "On-chain artwork for the newly created BanmaoBox", artworkLoading: "Loading on-chain NFT artwork…", artworkUnavailable: "The box was created successfully, but its artwork is not available from RPC yet. Your locked assets are unaffected.", retryArtwork: "Retry artwork", network: "Network", status: "Status", confirmed: "Confirmed", tokenId: "Token ID", boxesCreated: "Boxes created", viewBox: "View BanmaoBox", createAnother: "Create another box", successSummary: "Creation is complete. You can view the new box or start a new creation.", failureTitle: "Box creation was not completed", failureNotSubmitted: "No box-creation transaction was submitted. Your details are preserved so you can retry or edit them.", failureSubmitted: "A transaction was submitted but creation was not confirmed. Check it on the explorer before retrying.", retryCreation: "Try again", editDetails: "Edit details", close: "Close" },
  vi: { title: "BanmaoBox của bạn đã sẵn sàng", description: "Giao dịch đã được xác nhận trên X Layer. Đây là artwork được tạo on-chain cho NFT bạn vừa mint.", artworkAlt: "Artwork on-chain của BanmaoBox vừa tạo", artworkLoading: "Đang tải artwork NFT on-chain…", artworkUnavailable: "Box đã được tạo thành công nhưng RPC chưa trả về artwork. Tài sản đang khóa của bạn không bị ảnh hưởng.", retryArtwork: "Tải lại artwork", network: "Mạng", status: "Trạng thái", confirmed: "Đã xác nhận", tokenId: "Token ID", boxesCreated: "Số box đã tạo", viewBox: "Xem BanmaoBox", createAnother: "Tạo box khác", successSummary: "Đã tạo xong. Bạn có thể xem box mới hoặc bắt đầu tạo box khác.", failureTitle: "Chưa thể hoàn tất tạo box", failureNotSubmitted: "Chưa có giao dịch tạo box nào được gửi on-chain. Thông tin đã nhập được giữ lại để bạn thử lại hoặc chỉnh sửa.", failureSubmitted: "Giao dịch đã được gửi nhưng chưa xác nhận tạo box thành công. Hãy kiểm tra trên explorer trước khi thử lại.", retryCreation: "Thử lại", editDetails: "Chỉnh sửa thông tin", close: "Đóng" },
  zh: { title: "您的 BanmaoBox 已准备就绪", description: "交易已在 X Layer 上确认。这是为您刚铸造的 NFT 生成的链上作品。", artworkAlt: "新创建 BanmaoBox 的链上作品", artworkLoading: "正在加载链上 NFT 作品…", artworkUnavailable: "Box 已成功创建，但 RPC 暂未返回作品。您锁定的资产不受影响。", retryArtwork: "重试加载作品", network: "网络", status: "状态", confirmed: "已确认", tokenId: "Token ID", boxesCreated: "已创建 Box", viewBox: "查看 BanmaoBox", createAnother: "创建另一个 Box", successSummary: "创建已完成。您可以查看新 Box 或开始新的创建。", failureTitle: "Box 创建未完成", failureNotSubmitted: "尚未向链上提交交易。已保留您填写的信息，可重试或编辑。", failureSubmitted: "交易已提交，但尚未确认创建成功。重试前请先在浏览器中检查交易。", retryCreation: "重试", editDetails: "编辑详情", close: "关闭" },
  ko: { title: "BanmaoBox가 준비되었습니다", description: "거래가 X Layer에서 확인되었습니다. 방금 민팅한 NFT를 위해 온체인에서 생성된 아트워크입니다.", artworkAlt: "새 BanmaoBox의 온체인 아트워크", artworkLoading: "온체인 NFT 아트워크를 불러오는 중…", artworkUnavailable: "Box는 성공적으로 생성되었지만 RPC에서 아직 아트워크를 불러오지 못했습니다. 잠긴 자산에는 영향이 없습니다.", retryArtwork: "아트워크 다시 시도", network: "네트워크", status: "상태", confirmed: "확인됨", tokenId: "Token ID", boxesCreated: "생성된 Box", viewBox: "BanmaoBox 보기", createAnother: "다른 Box 만들기", successSummary: "생성이 완료되었습니다. 새 Box를 확인하거나 새로운 생성을 시작할 수 있습니다.", failureTitle: "Box 생성이 완료되지 않았습니다", failureNotSubmitted: "온체인에 제출된 거래가 없습니다. 다시 시도하거나 수정할 수 있도록 입력 내용이 유지됩니다.", failureSubmitted: "거래가 제출되었지만 Box 생성이 확인되지 않았습니다. 다시 시도하기 전에 탐색기에서 확인하세요.", retryCreation: "다시 시도", editDetails: "내용 수정", close: "닫기" },
  ru: { title: "Ваш BanmaoBox готов", description: "Транзакция подтверждена в X Layer. Это ончейн-изображение только что созданного NFT.", artworkAlt: "Ончейн-изображение нового BanmaoBox", artworkLoading: "Загрузка ончейн-изображения NFT…", artworkUnavailable: "Box успешно создан, но RPC пока не вернул изображение. Заблокированные активы не затронуты.", retryArtwork: "Повторить загрузку", network: "Сеть", status: "Статус", confirmed: "Подтверждено", tokenId: "Token ID", boxesCreated: "Создано Box", viewBox: "Открыть BanmaoBox", createAnother: "Создать другой Box", successSummary: "Создание завершено. Можно открыть новый Box или начать создание заново.", failureTitle: "Создание Box не завершено", failureNotSubmitted: "В сеть ничего не отправлено. Введённые данные сохранены для повтора или редактирования.", failureSubmitted: "Транзакция отправлена, но создание Box не подтверждено. Перед повтором проверьте её в обозревателе.", retryCreation: "Повторить", editDetails: "Изменить данные", close: "Закрыть" },
  id: { title: "BanmaoBox Anda sudah siap", description: "Transaksi telah dikonfirmasi di X Layer. Ini adalah artwork on-chain untuk NFT yang baru Anda mint.", artworkAlt: "Artwork on-chain BanmaoBox yang baru dibuat", artworkLoading: "Memuat artwork NFT on-chain…", artworkUnavailable: "Box berhasil dibuat, tetapi RPC belum menyediakan artwork. Aset terkunci Anda tidak terpengaruh.", retryArtwork: "Coba lagi artwork", network: "Jaringan", status: "Status", confirmed: "Terkonfirmasi", tokenId: "Token ID", boxesCreated: "Box dibuat", viewBox: "Lihat BanmaoBox", createAnother: "Buat Box lain", successSummary: "Pembuatan selesai. Anda dapat melihat Box baru atau memulai pembuatan baru.", failureTitle: "Pembuatan Box belum selesai", failureNotSubmitted: "Belum ada transaksi yang dikirim on-chain. Detail Anda dipertahankan agar dapat dicoba lagi atau diedit.", failureSubmitted: "Transaksi telah dikirim tetapi pembuatan Box belum dikonfirmasi. Periksa explorer sebelum mencoba lagi.", retryCreation: "Coba lagi", editDetails: "Edit detail", close: "Tutup" },
};
