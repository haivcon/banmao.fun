...
export const BOX_COPY: Record<BoxLanguage, BoxCopy> = {
  en: {
    ...
    invalidDuration: "Choose a lock duration of at least one day.",
  ...
  vi: {
    ...
    invalidDuration: "Chọn thời gian khóa tối thiểu một ngày.",
  ...
  ko: {
    ...
    invalidDuration: "최소 하루의 잠금 기간을 선택하세요.",
  ...
  ru: {
    ...
    invalidDuration: "Минимальный срок — один день.",
  ...
  id: {
    ...
    invalidDuration: "Pilih durasi minimal satu hari.",
