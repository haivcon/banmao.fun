                        ...
                        <div className="airdrop-footer-contract">
                            <div className="airdrop-footer-contract-item">
                                ...
                                <div className="airdrop-footer-addr-row">
                                    <a href="https://web3.okx.com/explorer/x-layer/evm/token/0x16d91d1615fc55b76d5f92365bd60c069b46ef78" target="_blank" rel="noopener noreferrer" className="airdrop-footer-address">
