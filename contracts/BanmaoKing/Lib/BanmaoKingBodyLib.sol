...
contract BanmaoKingBodyLib is IBanmaoKingBodyLib {
    ...
    function _costumeDetails() private pure returns (string memory) {
        return '<g id="costume-details"><path d="M165 194c17-42 49-64 91-64s76 22 91 64c6 53-26 91-91 94-65-3-97-41-91-94z" fill="none" stroke="#d8a91c" stroke-width="3.5" opacity=".82"/><path d="M158 412c10 31 36 50 70 58 15 4 30 5 44 3-31-12-55-34-69-65z" fill="#fff37a" opacity=".28"/><path d="M258 462c7 5 19 7 28 1-2 8-7 15-15 17-7-2-12-9-13-18z" fill="#79512f"/><path d="M258 462c1 9 6 16 13 18 8-2 13-9 15-17" fill="none" stroke="#65503a" stroke-width="1.8" stroke-linecap="round"/><path d="M264 468q7 4 15 1" fill="none" stroke="#c39b71" stroke-width="1.5" stroke-linecap="round"/></g>';
    }
