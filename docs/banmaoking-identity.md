...
- Logo coordinates and tile dimensions are halved only in the logo phase. Digit and scatter phases remain unchanged; five clusters each retain nine visible tiles.
